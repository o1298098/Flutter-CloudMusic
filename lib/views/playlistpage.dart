...
class PlayListPage extends StatefulWidget {
  ...
  @override
  PlayListPageState createState() => new PlayListPageState(id: id);
}
...
class PlayListPageState extends State<PlayListPage> {
  ...
  MusicPlayList s;
  PlayListPageState({this.id});
  void loadData() async {
    var r = await CloudMusicApiHelper.playListDetial(id);
    if (r.code == 200) {
      setState(() {
        s = r;
        backgroundurl = s.playlist.coverImgUrl;
      });
    }
  }
                        ...
                        child: Center(
                          child: Row(
                            children: <Widget>[
                              ...
                              Text('(共' +
                                  s.playlist.trackCount.toString() +
                                  '首)'),
                              Expanded(
                                child: SizedBox(),
                              ),
